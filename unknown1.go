...
// Unknown-1 dithering implementation
//
// imgIn is passed as a pointer for speed, but is not modified.
func DitherUnknown1(imgIn *image.RGBA) *image.RGBA {
